...
def test_submission_client():
    ...
    assert solution_data["wallet_address"] == "bc1qcmxyhlpm3lf9zvyevqas9n547lywws2e7wvuu1"
...
def test_model_caller_analysis():
    ...
    with patch.object(caller, 'call_model_with_math', return_value="PROCEED: All validations pass"):
