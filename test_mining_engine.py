...
def test_ai_interface() -> bool:
    ...
    try:
        ...
        assert recommendation in ["PROCEED", "HOLD", "RETRY", "ERROR"], f"Invalid recommendation: {recommendation}"
...
def test_mining_controller() -> bool:
    ...
    try:
        ...
        assert validate_solution(valid_solution) == True, "Valid solution should pass"
        assert validate_solution(invalid_solution) == False, "Invalid solution should fail"
