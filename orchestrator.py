...
class BitcoinMiningOrchestrator:
    ...
    def _log_status(self) -> None:
        ...
        if self.verbose and self.blocks_processed % 5 == 0:
            success_rate = (self.successful_submissions / self.blocks_processed * 100) if self.blocks_processed > 0 else 0
            self.log(f"Status: {self.blocks_processed} blocks processed, {self.successful_submissions} successful ({success_rate:.1f}%)")
